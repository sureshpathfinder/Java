...
public class shape extends Applet
{
    public void paint(Graphics g)
    {
        ...
        int b[]={325,240,358,380,420};
        Font  f = new Font("helvectica",Font.BOLD,25);
        g.setFont(f);
        g.drawString("Hello these are shapes in awt",250,30);
        ...
        g.draw3DRect(180,140,60,60,false);
        g.setColor(Color.pink);
        g.fill3DRect(180,140,60,60,false);
...
//<applet code="shape.class" height=500 width=500></applet>