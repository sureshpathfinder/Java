...
{
//dbc();
ss.executeUpdate("Update stud set name='"+t2.getText()+"', marks="+t3.getText()+" where rno="+t1.getText()+"");
t1.setText("");
t2.setText("");
t3.setText("");
}catch(Exception e){System.out.println(e);}
...
{
//dbc();
System.out.println("delete stud where rno="+t1.getText());
ss.executeUpdate("delete stud where rno="+t1.getText());
t1.setText("");
t2.setText("");
t3.setText("");
}catch(Exception e){System.out.println(e);}
...
while(rs.next())
{
ta.append(rs.getString("rno")+"\t"+rs.getString("name")+"\t"+rs.getString("marks")+"\n");
}
}catch(Exception e){System.out.println(e);}
}
}
