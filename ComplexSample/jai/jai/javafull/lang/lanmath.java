...
public class lanmath
{
        public static void main(String ar[])
        {
                ...
                System.out.println("Square root of 3 is:"+Math.sqrt(9));
 
                 System.out.println("Absolute value of -48 is:"+Math.abs(48));

                System.out.println("Ceiling 4.3(to the nearest integer greater than 4.3):"+Math.ceil(4.1));

                 System.out.println("Flooring 4.3(to the nearest integer lesser than 4.3):"+Math.floor(4.9));
               ...
               System.out.println("Rounded value of 7.4 is:"+Math.round(7.50));
